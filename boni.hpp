 ...
 */
template <
    typename handle_type, typename return_type,
    return_type (*destroy_function)(handle_type)>
...
public:
   ...
   */
  void operator()(handle_type handle_to_delete) {
 ...
 *  The "pointer" type must be
 *  [nullable](https://en.cppreference.com/w/cpp/named_req/NullablePointer),
...
template <
    ...
    typename handle_type = typename deleter_type::pointer,
    typename parent_type = std::unique_ptr<handle_type, deleter_type>>
